...
```
git clone git@github.com:andyinabox/grunt-wp-theme.git ~/.grunt-init/wp-theme
```

### Windows Users

```
git clone git@github.com:andyinabox/grunt-wp-theme.git %USERPROFILE%/.grunt-init/wp-theme
```
